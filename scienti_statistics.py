...
try:
    ...
    gruplac_articulos = pd.read_csv('data/extracted_data/aux_articulosg.csv', dtype = str)
    gruplac_basico = pd.read_csv('data/extracted_data/aux_basicog.csv', dtype = str)
    gruplac_caplibros = pd.read_csv('data/extracted_data/aux_caplibrosg.csv', dtype = str)
    gruplac_integrantes = pd.read_csv('data/extracted_data/aux_integrantes.csv', dtype = str)
    gruplac_libros = pd.read_csv('data/extracted_data/aux_librosg.csv', dtype = str) 
    gruplac_oarticulos = pd.read_csv('data/extracted_data/aux_oarticulos.csv', dtype = str)
    gruplac_olibros = pd.read_csv('data/extracted_data/aux_olibros.csv', dtype = str)
    gruplac_cdoctorado= pd.read_csv('data/extracted_data/aux_cdoctorado.csv', dtype = str)
    gruplac_cmaestria= pd.read_csv('data/extracted_data/aux_cmaestria.csv', dtype = str)
    gruplac_disenoind= pd.read_csv('data/extracted_data/aux_disenoind.csv', dtype = str)
    gruplac_empresatec= pd.read_csv('data/extracted_data/aux_empresatecg.csv', dtype = str)
    gruplac_innovaempresa= pd.read_csv('data/extracted_data/aux_innovaempresag.csv', dtype = str)
    gruplac_instituciones= pd.read_csv('data/extracted_data/aux_instituciones.csv', dtype = str)
    gruplac_lineas= pd.read_csv('data/extracted_data/aux_lineas.csv', dtype = str)
    gruplac_otecnologicos= pd.read_csv('data/extracted_data/aux_otecnologicos.csv', dtype = str)
    gruplac_pdoctorado= pd.read_csv('data/extracted_data/aux_pdoctorado.csv', dtype = str)
    gruplac_plantapiloto= pd.read_csv('data/extracted_data/aux_plantapilotog.csv', dtype = str)
    gruplac_pmaestria= pd.read_csv('data/extracted_data/aux_pmaestria.csv', dtype = str)
    gruplac_prototipos= pd.read_csv('data/extracted_data/aux_prototiposg.csv', dtype = str)
    gruplac_software= pd.read_csv('data/extracted_data/aux_softwareg.csv', dtype = str)
    
    cvlac_areas=pd.read_csv('data/extracted_data/aux_actuacion.csv', dtype = str)
    cvlac_articulos=pd.read_csv('data/extracted_data/aux_articulos.csv', dtype = str)
    cvlac_basico=pd.read_csv('data/extracted_data/aux_basico.csv', dtype = str)
    cvlac_lineas=pd.read_csv('data/extracted_data/aux_investigacion.csv', dtype = str)
    cvlac_libros=pd.read_csv('data/extracted_data/aux_libros.csv', dtype = str)
    cvlac_reconocimiento=pd.read_csv('data/extracted_data/aux_reconocimiento.csv', dtype = str)
    cvlac_caplibros=pd.read_csv('data/extracted_data/aux_caplibros.csv', dtype = str)
    cvlac_empresatec=pd.read_csv('data/extracted_data/aux_empresatec.csv', dtype = str)
    cvlac_innovaempresa=pd.read_csv('data/extracted_data/aux_innovaempresa.csv', dtype = str)
    cvlac_prototipos=pd.read_csv('data/extracted_data/aux_prototipo.csv', dtype = str)
    cvlac_software=pd.read_csv('data/extracted_data/aux_software.csv', dtype = str)
    cvlac_tecnologicos=pd.read_csv('data/extracted_data/aux_tecnologicos.csv', dtype = str)
    cvlac_identificadores=pd.read_csv('data/extracted_data/aux_identificadores.csv', dtype = str)
    gruplac_duplicados={'articulos':[],'libros':[],'oarticulos':[],'libros':[],'olibros':[],'caplibros':[],'otecnologicos':[],'software':[],'prototipos':[]}
...
"""
cvlac_articulos.to_csv('data/extracted_data/cvlac_articulos.csv',index=False)
cvlac_basico.to_csv('data/extracted_data/cvlac_basico.csv',index=False)
cvlac_caplibros.to_csv('data/extracted_data/cvlac_caplibros.csv',index=False)
cvlac_libros.to_csv('data/extracted_data/cvlac_libros.csv',index=False)
cvlac_empresatec.to_csv('data/extracted_data/cvlac_empresatec.csv',index=False)
cvlac_innovaempresa.to_csv('data/extracted_data/cvlac_innovaempresa.csv',index=False)
cvlac_lineas.to_csv('data/extracted_data/cvlac_lineas.csv',index=False)
cvlac_tecnologicos.to_csv('data/extracted_data/cvlac_otecnologicos.csv',index=False)
cvlac_prototipos.to_csv('data/extracted_data/cvlac_prototipos.csv',index=False)
cvlac_software.to_csv('data/extracted_data/cvlac_software.csv',index=False)
cvlac_areas.to_csv('data/extracted_data/cvlac_areas.csv',index=False)
cvlac_reconocimiento.to_csv('data/extracted_data/cvlac_reconocimiento.csv',index=False)
cvlac_identificadores.to_csv('data/extracted_data/cvlac_identificadores.csv',index=False)
"""
...
#GUARDAR CONJUNTOS DE DATOS LIMPIOS
"""
gruplac_articulos.to_csv('data/extracted_data/gruplac_articulos.csv',index=False)
gruplac_basico.to_csv('data/extracted_data/gruplac_basico.csv',index=False)
gruplac_caplibros.to_csv('data/extracted_data/gruplac_caplibros.csv',index=False)
gruplac_integrantes.to_csv('data/extracted_data/gruplac_integrantes.csv',index=False)
gruplac_libros.to_csv('data/extracted_data/gruplac_libros.csv',index=False)
gruplac_oarticulos.to_csv('data/extracted_data/gruplac_oarticulos.csv',index=False)
gruplac_olibros.to_csv('data/extracted_data/gruplac_olibros.csv',index=False)
gruplac_cdoctorado.to_csv('data/extracted_data/gruplac_cdoctorado.csv',index=False)
gruplac_cmaestria.to_csv('data/extracted_data/gruplac_cmaestria.csv',index=False)
gruplac_disenoind.to_csv('data/extracted_data/gruplac_disenoind.csv',index=False)
gruplac_empresatec.to_csv('data/extracted_data/gruplac_empresatec.csv',index=False)
gruplac_innovaempresa.to_csv('data/extracted_data/gruplac_innovaempresa.csv',index=False)
gruplac_instituciones.to_csv('data/extracted_data/gruplac_instituciones.csv',index=False)
gruplac_lineas.to_csv('data/extracted_data/gruplac_lineas.csv',index=False)
gruplac_otecnologicos.to_csv('data/extracted_data/gruplac_otecnologicos.csv',index=False)
gruplac_pdoctorado.to_csv('data/extracted_data/gruplac_pdoctorado.csv',index=False)
gruplac_plantapiloto.to_csv('data/extracted_data/gruplac_plantapiloto.csv',index=False)
gruplac_pmaestria.to_csv('data/extracted_data/gruplac_pmaestria.csv',index=False)
gruplac_prototipos.to_csv('data/extracted_data/gruplac_prototipos.csv',index=False)
gruplac_software.to_csv('data/extracted_data/gruplac_software.csv',index=False)
"""
